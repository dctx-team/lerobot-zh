...
本项目提供中英文双语文档。This project provides bilingual documentation in Chinese and English.
...
- Chinese documentation files end with `_zh`
- Keep original files unchanged, create separate Chinese versions
