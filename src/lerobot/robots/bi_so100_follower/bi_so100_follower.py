...
class BiSO100Follower(Robot):
    """
    由TheRobotStudio设计的[双臂SO-100从动机械臂](https://github.com/TheRobotStudio/SO-ARM100)。

    这个双臂机器人也可以轻松适配使用SO-101从动机械臂，只需将SO100Follower类替换为SO101Follower，
    并将SO100FollowerConfig替换为SO101FollowerConfig。
    """
