...
class BiSO100Leader(Teleoperator):
    """
    由 TheRobotStudio 设计的[双臂 SO-100 主控臂](https://github.com/TheRobotStudio/SO-ARM100)
    这个双臂主控臂也可以很容易地适配使用 SO-101 主控臂，只需将 SO100Leader 类替换为 SO101Leader，将 SO100LeaderConfig 替换为 SO101LeaderConfig。
    """
