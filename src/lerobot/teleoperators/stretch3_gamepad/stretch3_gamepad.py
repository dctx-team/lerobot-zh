...
# 来自 stretch_body.gamepad_controller.GamePadController
GAMEPAD_BUTTONS = [
...
class Stretch3GamePad(Teleoperator):
    """[Stretch 3](https://hello-robot.com/stretch-3-product)，由 Hello Robot 制造。"""
    ...
    def connect(self) -> None:
        ...
        self.api.startup()
        self.api._update_state()  # 检查控制器可以被读取和写入
