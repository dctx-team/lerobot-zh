...
class WidowX(Teleoperator):
    """
    由 Trossen Robotics 开发的 [WidowX](https://www.trossenrobotics.com/widowx-250)
    """
    ...
    def calibrate(self) -> None:
        raise NotImplementedError  # TODO(aliberts): 调整以下代码（从 koch 复制而来）
        ...
        print(
            f"依次移动除 {full_turn_motors} 之外的所有关节，使其通过各自的整个运动范围。\n"
            "正在记录位置。按 ENTER 停止..."
        )
    ...
    def configure(self) -> None:
        ...
        # 为肩部和肘部设置次级/影子ID。这些关节有两个电机。
        # 因此，如果只要求其中一个移动到某个位置，另一个将跟随。
        # 这是为了避免损坏电机。
